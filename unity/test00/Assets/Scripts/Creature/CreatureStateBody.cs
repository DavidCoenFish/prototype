...
public class CreatureStateBody
{
    ...
    public CreatureStateBody()
    {
        ...
        splineRenderDataArray.Add(new SplineRenderData(){
            ...
            p0=new UnityEngine.Vector4(0.0f, 0.573f, 0.043f, 0.55f) + debugZOffset,
            p1=new UnityEngine.Vector4(0.0f, 0.837f, -0.026f, 0.6f) + debugZOffset,
            p2=new UnityEngine.Vector4(0.0f, 1.102f, 0.080f, 0.55f) + debugZOffset
        });
        //arm
        splineRenderDataArray.Add(new SplineRenderData(){
            color=new UnityEngine.Color(0.0f, 0.0f, 1.0f, 1.0f),
            p0=new UnityEngine.Vector4(0.293f, 0.962f, -0.016f, 0.04f) + debugZOffset,
            p1=new UnityEngine.Vector4(0.415f, 0.745f, -0.016f, 0.04f) + debugZOffset,
            p2=new UnityEngine.Vector4(0.415f, 0.517f, -0.016f, 0.04f) + debugZOffset,
        });
        //leg
        splineRenderDataArray.Add(new SplineRenderData(){
            color=new UnityEngine.Color(1.0f, 0.0f, 0.0f, 1.0f),
            p0=new UnityEngine.Vector4(0.196f, 0.375f, 0.116f, 0.04f) + debugZOffset,
            p1=new UnityEngine.Vector4(0.241f, 0.202f, 0.076f, 0.04f) + debugZOffset,
            p2=new UnityEngine.Vector4(0.247f, 0.02f, 0.165f, 0.04f) + debugZOffset,
        });
        //foot
        splineRenderDataArray.Add(new SplineRenderData(){
            color=new UnityEngine.Color(1.0f, 0.0f, 0.0f, 1.0f),
            p0=new UnityEngine.Vector4(0.247f, 0.02f, 0.165f, 0.04f) + debugZOffset,
            p1=new UnityEngine.Vector4(0.247f, 0.027f, 0.089f, 0.04f) + debugZOffset,
            p2=new UnityEngine.Vector4(0.247f, 0.02f, 0.001f, 0.04f) + debugZOffset,
        });
        //arm
        splineRenderDataArray.Add(new SplineRenderData(){
            color=new UnityEngine.Color(0.0f, 0.0f, 1.0f, 1.0f),
