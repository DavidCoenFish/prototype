...
const factory = function(in_document, in_text, in_callbackGetX, in_callbackSetX, in_callbackGetY, in_callbackSetY, in_callbackGetZ, in_callbackSetZ, in_callbackGetW, in_callbackSetW, in_minOrUndefined, in_maxOrUndefined, in_stepOrUndefined){
	...
	var m_inputW = createInput(in_document, in_callbackGetW, in_callbackSetW, in_minOrUndefined, in_maxOrUndefined, in_stepOrUndefined);
...
export default function(in_document, in_text, in_vec4, in_minOrUndefined, in_maxOrUndefined, in_stepOrUndefined){
	return factory(
		in_document, 
		in_text, 
