...
const factory = function(in_webGLContextWrapper, in_resourceManager, in_heightTexture){
	var m_height = 0.1;
	var m_tilt = 30.0;
	...
	const m_materialWater = WebGL.MaterialWrapper.factoryDefault(m_shaderWater, [in_heightTexture]);
