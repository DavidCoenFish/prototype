...
const factory = function(in_red, in_green, in_blue, in_baseArrayClass){
	const data = new in_baseArrayClass([in_red, in_green, in_blue]);
...
const factoryFloat32 = function(in_redOrUndefined, in_greenOrUndefined, in_blueOrUndefined, in_alphaOrUndefined){
	...
	return factory(red, green, blue, Float32Array);
}
...
const factoryUnsignedByte = function(in_redOrUndefined, in_greenOrUndefined, in_blueOrUndefined){
	...
	return factory(red, green, blue, Uint8Array);
}
...
module.exports = {
	...
	"cmpAlmost" : cmpAlmost,
	"sRed" : factoryFloat32(1.0, 0.0, 0.0),
	"sGreen" : factoryFloat32(0.0, 1.0, 0.0),
	"sBlue" : factoryFloat32(0.0, 0.0, 1.0),
	"sBlack" : factoryFloat32(0.0, 0.0, 0.0),
}
