...
export default function(
	...
	const that = Object.create({
		...
		//in_formatEnumName
		//ALPHA, RGB, RGBA
		"readTexturePixel" : function(out_pixels, in_formatEnumName, in_typeEnumName, in_x, in_y, in_width, in_height){
			...
			const typeEnum = m_webGLContextWrapper.getEnum(in_typeEnumName);
			m_webGLContextWrapper.callMethod("readPixels", in_x, in_y, in_width, in_height, formatEnum, typeEnum, out_pixels);
