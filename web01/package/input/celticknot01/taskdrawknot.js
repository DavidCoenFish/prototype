...
export default function (in_resourceManager, in_webGLState, in_width, in_height, in_tileWidth, in_tileHeight) {
	...
	funcUpdateGrid(in_width, in_height, 0, 0, 0);
	...
	generateModel(in_width, in_height);
	...
	updateModel(in_width, in_height);
