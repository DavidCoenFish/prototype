...
export const factory = function(
	...
	const result = Object.create({
		...
		"getAt" : function(){ return Vector3Factory(data[0], data[1], data[2], in_baseArrayClass); },
		"setAt" : function(in_vec){ data[0] = in_vec.getX(); data[1] = in_vec.getY(); data[2] = in_vec.getY(); return; },

		"getLeft" : function(){ return Vector3Factory(data[3], data[4], data[5], in_baseArrayClass); },
		"setLeft" : function(in_vec){ data[3] = in_vec.getX(); data[4] = in_vec.getY(); data[5] = in_vec.getY(); return; },

		"getUp" : function(){ return Vector3Factory(data[6], data[7], data[8], in_baseArrayClass); },
...
export const factoryQuaternion = function(in_quaternion){
...
export const transformVector3 = function(in_matrix, in_vector3){
